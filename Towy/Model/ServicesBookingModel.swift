...
struct DriverList : Codable {
    ...
    init(from decoder: Decoder) throws {
        ...
        distanceFare = try values.decodeIfPresent(Int.self, forKey: .distanceFare)
        service_fare = try values.decodeIfPresent(Int.self, forKey: .service_fare)
