...
//        self.rideprogress = nil
    ...
    init(newRide: NewRide? = nil,booking:BookingInfo? = nil, rideCancel: String? = nil, rideDropOffChange: NewRide? = nil, type: Key.notificationKey.NotificationType,message:Message?) {
