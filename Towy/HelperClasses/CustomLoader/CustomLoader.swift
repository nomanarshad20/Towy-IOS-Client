...
public func ShowLoaderWithMessage(message:String) {
    startActivityAnimating(size: CGSize(width:56, height:56), message: message, type: NVActivityIndicatorType.circleStrokeSpin, color:.black, padding: 2,isFromOnView: false)
}

public func SHOW_CUSTOM_LOADER() {
    startActivityAnimating(size: CGSize(width:56, height:56), message: nil, type: NVActivityIndicatorType.circleStrokeSpin, color:.black, padding: 2,isFromOnView: false)
}

public func SHOW_CUSTOM_LOADER_MSG(message: String) {
    startActivityAnimating(size: CGSize(width:56, height:56), message: message, type: .circleStrokeSpin, color: UIColor.white, padding: 2, isFromOnView: false)
}
